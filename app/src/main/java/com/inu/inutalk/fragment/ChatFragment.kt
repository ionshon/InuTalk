package com.inu.inutalk.fragment
...
import com.inu.inutalk.R
import com.inu.inutalk.model.ChatModel
import com.inu.inutalk.model.Friend
import java.util.*
            ...
            fireDatabase.child("chatrooms").orderByChild("users/$uid").equalTo(true).addListenerForSingleValueEvent(object :
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for(data in snapshot.children){
                        chatModel.add(data.getValue<ChatModel>()!! as ChatModel)
                        println(data)
                    }
